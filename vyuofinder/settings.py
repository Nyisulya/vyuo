"""
Django settings for vyuofinder project.
...
ALLOWED_HOSTS = ['vyuotanzania.nyisu.com', 'localhost', '127.0.0.1']
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "University Portal",
    "welcome_sign": "Karibu kwenye Portal ya Vyuo",
    "search_model": ["universitysite.University"],
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'universitysite', 'static'),
]
STORAGES = {
    'default': {
